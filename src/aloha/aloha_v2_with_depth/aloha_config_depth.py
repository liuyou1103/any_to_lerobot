...
class DataConfig:
    ...
    # source_data_json = [
    #     '/home/diy01/Documents/annotation/realman/realman构建块project-352-at-2025-07-08-05-49-bf414113.json'
    # ]
    ...
    rgb_names_2 = [
        ...
        {'observation.images.cam_right_wrist':{
         ...
         {'observation.images.cam_high_realsense':{
            "dtype": "video",
            "shape": [
                480,
                640,
    ...
    action_len = 28
    rgb_names_depth = {
        'observation.images.depth_cam_high_realsense':{
            "dtype": "video",
            "shape": [
                720,
                1280,
    ...
    rgb_names_depth_2 = {
        'observation.images.depth_cam_high':{
            "dtype": "video",
            "shape": [
                768,
                1024,
