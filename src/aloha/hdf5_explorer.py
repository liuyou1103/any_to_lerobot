...
def process_hdf5_file(input_file, output_prefix):
    ...
    try:
        ...
        if "file signature not found" in str(e):
            print(str(e))
            raise ValueError("文件不是有效的 HDF5 格式或已损坏。")
        else:
            raise e
...
if __name__ == "__main__":
    ...
    input_file = '/home/diy01/aloha/aloha/docker/1.上传数据/WD14T/松灵分体/task_Basket_banana_500_5.13/task_black_left_Basket_banana_125_5.12/episode_110.hdf5'
    output = '/home/diy01/lerobot/src/aloha'
    process_hdf5_file(input_file, output)
    print("\nDone!")
    # dd()