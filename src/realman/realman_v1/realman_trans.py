...
class DataProcessor(object):
    ...
    def download_from_nas(self, nas_path, an_path):
        ...
        # 定义文件夹名称映射关系（中文键 -> 英文值）
        fold_name = {
            "封装袋（realman孝帅老师）":"task_document_realman_500_4.24",
            "叠毛巾（realman孝帅老师）":"task_fold_towels_500_5.05",
            "篮子收纳蛋黄酥2（realman孝帅老师）":"task_basket_store_egg_tart_500_5.06",
            "篮子收纳橘子（realman孝帅老师）":"task_Basket _orang_500_5.11",
        }
