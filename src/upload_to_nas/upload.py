...
if __name__ == "__main__":
    # 配置路径
    nas_path = '/docker/2.lerobot/aloha'  # NAS 基础路径
    local_parent_path = '/home/diy01/aloha_wait_for_upload'
    local_path_list = [
        'aloha_2025.5.30-fold clothes(new)(2000)1_white_back',
        'aloha_2025.5.30-fold clothes(new)(2000)1_white_front',
        'aloha_task_food_packaging_500_5.21',
        'aloha_task_glasses_case_500_5.19',
        'aloha_task_make_hamburger_1111_6.12_1',
        'aloha_task_make_hamburger_1111_6.12_2',
        'aloha_task_make_hamburger_1111_6.12_3',
        'aloha_task_make_hamburger_1111_6.12_4',
        'aloha_task_make_hamburger_1111_6.12_5',
        'aloha_task_twist_cap_1000_6.10_KangShiFu',
        'aloha_task_twist_cap_1000_6.10_LvCha',
        'aloha_task_twist_cap_1000_6.10_MeiNianDa',
        'aloha_task_twist_cap_1000_6.10_YiBao',
        'aloha_task_twist_cap_1000_6.10_YiLi',
    ]
